...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is olivia. :D")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at wellesley college.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm studying computer science and japanese.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm currently exploring web design.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i like to bake pies.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to draw.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
